...
const Timeline = (props: { jobs: Job[], initialSlide?: number }) => {
    const [slide, setSlide] = useState({ slide: props.initialSlide ?? 0, direction: 1 });
...
const CareerPage = () => <div className="flex flex-col gap-y-4">
    <div className="mb-4">
        ...
        <Timeline jobs={jobs} initialSlide={2} />
        <TimelineMobile jobs={jobsMobile} />
    </div>
    <div>
